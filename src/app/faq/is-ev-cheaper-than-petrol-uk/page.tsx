    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="bg-ev-green/5 border border-ev-green/30 rounded-2xl p-5 mb-8">
        ...
        <p className="text-sm text-navy leading-relaxed">
          <strong>Yes, if you charge at home.</strong> An EV costs 7–8p per mile on a standard home
          tariff versus 16–19p per mile for petrol — a saving of 8–11p per mile.
          At 10,000 miles this is £800–£1,100 per year. Without a home charger,
          public charging at 70p/kWh costs about 20p per mile — similar to or
          more than petrol.
        </p>
      </div>
          ...
          <div className="bg-off-white border border-border-light rounded-xl p-4 my-4">
            <div className="grid grid-cols-2 gap-6 text-sm">
              <div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    { label: "Standard tariff (28p/kWh)", value: "8p/mile", highlight: false },
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    { label: "Standard public (60p/kWh)", value: "17p/mile", highlight: false },
                    { label: "Rapid public (75p/kWh)", value: "21p/mile", highlight: false },
                  ].map((row) => (
                    <div key={row.label} className="flex justify-between items-center">
                      <span className="text-ev-grey text-xs">{row.label}</span>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    { label: "50 MPG efficient petrol", value: "13p/mile" },
                    { label: "40 MPG average petrol", value: "16.3p/mile" },
                    { label: "30 MPG urban petrol", value: "21.8p/mile" },
                  ].map((row) => (
                    <div key={row.label} className="flex justify-between items-center">
                      <span className="text-ev-grey text-xs">{row.label}</span>
                      <span className="font-bold text-sm text-ev-amber">{row.value}</span>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[
                    { label: "60 MPG efficient diesel", value: "11.6p/mile" },
                    { label: "50 MPG average diesel", value: "13.9p/mile" },
                    { label: "40 MPG urban diesel", value: "17.3p/mile" },
                  ].map((row) => (
                    <div key={row.label} className="flex justify-between items-center">
                      <span className="text-ev-grey text-xs">{row.label}</span>
                      <span className="font-bold text-sm text-ev-amber">{row.value}</span>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {[8000, 10000, 12000, 15000, 20000].map((miles, i) => {
                  const evCost = Math.round(miles * 0.08);
                  const petrolCost = Math.round(miles * 0.163);
